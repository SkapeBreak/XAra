...
namespace SpatialCapture
{
	...
	{
		public ARPlaneMesh1[] meshList;
		public PNLandmark1[] landmarkList;
	}
...
namespace SpatialCapture
{
    public class CapturedARGeneratePlane1 : MonoBehaviour
    {
        ...
        void Start()
        {
            ...
            {
                CapturedPlaneUtility1.InitializePlanePrefab(meshPrefab);
            }
            else
            {
                CapturedPlaneUtility1.InitializePlanePrefab(planePrefab);
            }
        }
        ...
        public void LoadPlaneList(JToken mapMetadata)
        {
            ...
            if (mapMetadata is JObject && mapMetadata["planes"] is JObject)
            {
                ...
                {
					GameObject go = CapturedPlaneUtility1.CreatePlaneInScene(plane);
