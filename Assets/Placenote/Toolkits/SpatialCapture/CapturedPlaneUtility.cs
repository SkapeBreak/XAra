...
{
    public class CapturedPlaneUtility1
    {
		...
		public static GameObject CreatePlaneInScene(SpatialCapture.ARPlaneMesh1 arPlane)
		{
			GameObject plane;	
			if (planePrefab != null) {
			...
			CapturedPlaneMeshRender1 ppmr = plane.GetComponent<CapturedPlaneMeshRender1> ();
			if (ppmr != null) {
		...
		public static GameObject UpdatePlaneWithAnchorTransform(GameObject plane, ARPlaneMesh1 arPlane)
		{
